...
const About = () => {
  return (
    <>
    <div className="w-full min-h-screen md:h-screen bg-cover bg-no-repeat bg-about flex flex-col gap-5 items-center justify-center text-white pb-10">
      <h1 className="font-black text-center text-6xl capitalize">Help the children</h1>
      <p className="w-full px-5 md:px-0 md:w-1/2 text-lg text-center">We do whatever it takes to make sure children don't just survive but thrive. Helper believes that every child should be able to make on their world and help build a better future.</p>
    </div>

    <section className="mt-10 px-2 md:px-28 pb-10 flex flex-col gap-10">
      <div className="flex odd:flex-row even:flex-row-reverse justify-between items-center gap-x-0 md:gap-x-10 ">
